...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(\App\Repositories\Contracts\TypeCinemaRepository::class, \App\Repositories\Eloquent\TypeCinemaRepositoryEloquent::class);
        $this->app->bind(\App\Repositories\Contracts\TypeCinemaUserRepository::class, \App\Repositories\Eloquent\TypeCinemaUserRepositoryEloquent::class);
        //:end-bindings:
    }
}
